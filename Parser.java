class Parser
{
    ...
    private Expression parseTerm() throws InvalidOperationException
    {
    ...
    private static boolean isAddOp(final int tkcode) { return tkcode == Constants.TK_PLUS || tkcode == Constants.TK_MINUS; }
    private static boolean isMultOp(final int tkcode) { return tkcode == Constants.TK_TIMES || tkcode == Constants.TK_DIVIDE; }

    private int parseBinaryOp() throws InvalidOperationException
    {
    ...
    private void nextToken() throws InvalidOperationException
    {
        try
        {
    ...
    /************************
     error handling
     ************************/
    private void expected(final String msg) throws InvalidOperationException
    {
    ...
    private void expectNewline() throws InvalidOperationException
    {
